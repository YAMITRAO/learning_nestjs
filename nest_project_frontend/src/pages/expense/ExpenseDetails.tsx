...
const ExpenseDetails: React.FC<ExpenseDetailsProps_int> = ({
  ...
  return (
    <div className="w-full min-w-[400px] h-auto p-2 flex flex-col">
      <div className="w-full h-auto  pt-4 px-2">
        {/* title graph */}
        <div className="w-full text-center text-lg font-mono text-slate-400 bg-gradient-to-r  from-[#dde1e2] to-[#2bacc3] bg-clip-text text-transparent">
          Expense Graph
        </div>
        {/* pi graph */}
      ...
      {/* graph container :- not in used remove later */}
      {false && (
        <div className="w-full h-auto  pt-4 px-2">
      ...
      {/* details container */}
      <div className="w-[76%] mx-auto flex gap-2 justify-center text-lg font-medium">
        {/* total Imcome */}
